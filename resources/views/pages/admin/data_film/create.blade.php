				...
				<div class="card-body">
					...
					autocomplete="off">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control {{$errors->has('judul')?'is-invalid':''}}" name="judul"
						...
						<div class="row" style="margin-top: 10px;">
							<div class="col-md-2">
								<label for="example-time-input" class="control-label">Durasi</label>
							</div>
							<div class="col-md 10 row">
								<div class="col-md-2">
									<input type="number" value="{{old('durasi')}}" name="durasi" id="example-time-input"
									class="form-control">
								</div>
								<div class="col-md-1 d-flex justify-content-center align-items-center rounded bg-primary text-white">
									<span>Menit</span>
								</div>
